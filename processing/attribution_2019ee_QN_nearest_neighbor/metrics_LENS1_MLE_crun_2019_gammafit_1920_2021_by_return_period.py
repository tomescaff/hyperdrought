...
lens1_prec_full = lens.get_LENS1_annual_precip_NOAA_QN_NN()
...
# counterfactual
cr = lens.get_LENS1_annual_precip_control_run_QN_NN()
...
# bootstrap MLE
nboot = 100
filepath = '../../../hyperdrought_data/output/MLE_2019ee_LENS1_GMST_'+str(nboot)+'_evaluation_QN_NN.nc'
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/metrics_LENS1_MLE_crun_{ac_year}_gammafit_1920_2021_by_return_period_QN_NN.csv'))