...
# bootstrap MLE
nboot = 100
filepath = '../../../hyperdrought_data/output/MLE_2019ee_LENS1_GMST_'+str(nboot)+'_future_QN_NN.nc'
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/metrics_LENS1_MLE_{ac_year}_{fu_year}_gammafit_2010_2100_by_return_period_QN_NN.csv'))