...
# counterfactual
cr = lens.get_LENS1_JFM_precip_control_run_PM()
...
# bootstrap MLE
nboot = 100
filepath = '../../../hyperdrought_data/output/PM_MLE_precip_LENS1_GMST_'+str(nboot)+'_evaluation.nc'
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/PM_metrics_LENS1_MLE_crun_{ac_year}_gammafit_1920_2021_by_return_period.csv'))