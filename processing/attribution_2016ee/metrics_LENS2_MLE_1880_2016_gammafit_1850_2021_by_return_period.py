...
# bootstrap MLE
nboot = 1000
filepath = '../../../hyperdrought_data/output/PM_MLE_precip_LENS2_GMST_'+str(nboot)+'_evaluation.nc'
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/PM_metrics_LENS2_MLE_{cf_year}_{ac_year}_gammafit_1850_2021_by_return_period.csv'))