...
lens1_prec_full = lens.get_LENS1_JFM_precip_NOAA_PM_NN()
...
# counterfactual
cr = lens.get_LENS1_JFM_precip_control_run_PM_NN()
...
# bootstrap MLE
nboot = 1000
filepath = '../../../hyperdrought_data/output/MLE_2016ee_LENS1_GMST_'+str(nboot)+'_evaluation_PM_NN.nc'
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/metrics_LENS1_MLE_crun_{ac_year}_gammafit_1920_2021_by_return_period_PM_NN.csv'))