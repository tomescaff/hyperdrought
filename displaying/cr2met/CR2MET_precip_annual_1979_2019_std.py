...
da = da.sel(time=slice('1979', '2019')).std('time')
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap='jet', zorder=4, vmin=0, vmax=700)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_1979_2019_std.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()