...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred, zorder=1, vmin=-1, vmax=1)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_corr_CO.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()