...
da = ut.get_CR2MET_2016_JFM_precip_ranking()
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_ranking_2016.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()