...
# get CR2MET precip
da = cr2met.get_cr2met_JFM_precip_acc()
da = da.sel(time=slice('1979', '2019')).mean('time')/(31+28+31)
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=0, vmax=8)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_clim.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()