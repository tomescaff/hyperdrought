...
qnf = cr2met.get_regional_index().sel(time=slice('1960', '2021')) #se.get_QN_annual_precip_long_record()#
...
plt.plot(x_norm_2019, y, color='r', lw=1.2, label = 'Gamma scale fit 2019')
...
plt.axhline(qnf.sel(time='2019'), color='fuchsia', lw=1.2, label='Observed 2019')
...
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/RI_MLE_precip_return_period_fit_1960_2021.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()