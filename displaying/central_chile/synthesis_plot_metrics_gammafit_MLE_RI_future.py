...
obs_mle_1880 = pd.read_csv(join(currentdir, relpath, 'metrics_RI_MLE_2019_2070_gammafit_1960_2021.csv'), index_col=0)
lens1_mle_cr = pd.read_csv(join(currentdir, relpath, 'metrics_LENS1_MLE_2019_2070_gammafit_2010_2100_by_return_period_RI.csv'), index_col=0)
lens2_mle_1880 = pd.read_csv(join(currentdir, relpath, 'metrics_LENS2_MLE_2019_2070_gammafit_2010_2100_by_return_period_RI.csv'), index_col=0)
...
plt.tight_layout()
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/synthesis_plot_metrics_gammafit_MLE_RI_future.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()