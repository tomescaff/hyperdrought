...
obs_mle_1880 = pd.read_csv(join(currentdir, relpath, 'metrics_RI_MLE_1880_2019_gammafit_1960_2021.csv'), index_col=0)
lens1_mle_cr = pd.read_csv(join(currentdir, relpath, 'metrics_LENS1_MLE_crun_2019_gammafit_1920_2021_by_return_period_RI.csv'), index_col=0)
lens2_mle_1880 = pd.read_csv(join(currentdir, relpath, 'metrics_LENS2_MLE_1880_2019_gammafit_1850_2021_by_return_period_RI.csv'), index_col=0)
...
plt.tight_layout()
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/synthesis_plot_metrics_gammafit_MLE_RI.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()