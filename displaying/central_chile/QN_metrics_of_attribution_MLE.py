...
sm_no2017 = sm.where(sm.time.dt.year != 2019, drop=True)
qn_n02017 = qn.where(qn.time.dt.year != 2019, drop=True)

xopt = pmath.mle_gamma_2d(qn_n02017.values, sm_no2017.values, [70, 4, -0.5])
...
df.to_csv(join(currentdir,f'../../../hyperdrought_data/output/2019ee_metrics_of_attr_QN_MLE_{cf_year}_{ac_year}.csv'))