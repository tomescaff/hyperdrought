...
lens1_mle_cr = pd.read_csv(join(relpath, 'metrics_LENS1_MLE_crun_2019_gammafit_1920_2021_by_return_period_QN_NN.csv'), index_col=0)
lens2_mle_1880 = pd.read_csv(join(relpath, 'metrics_LENS2_MLE_1880_2019_gammafit_1850_2021_by_return_period_QN_NN.csv'), index_col=0)
...
plt.tight_layout()
plt.savefig('../../../hyperdrought_data/png/sysnthesis_plot_metrics_gammafit_MLE_NN.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()
