...
nboot = 1000
filepath = '../../../hyperdrought_data/output/MLE_precip_QN_GMST_'+str(nboot)+'_evaluation.nc'
...
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/QN_MLE_precip_GMST_scatter.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()