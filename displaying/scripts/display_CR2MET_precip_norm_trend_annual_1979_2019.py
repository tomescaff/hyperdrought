...
# get CR2MET precip
trend = xr.open_dataset('../../../hyperdrought_data/data/CR2MET_norm_trend_1979_2019.nc')['slope']
da = trend*10*100
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-15, vmax=15)
...
cbar.ax.set_ylabel('Annual Precip Trend (1979-2019) (%/dec)', fontdict={'fontsize':10})

plt.savefig('../../../hyperdrought_data/png/CR2MET_precip_norm_trend_annual_1979_2019.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()