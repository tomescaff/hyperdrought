...
# get LENS2 precip
trend = xr.open_dataset('../../../hyperdrought_data/data/LENS2_trend_1981_2010.nc')['slope']
da = trend.mean('run')*10 #/clim*100
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.MPL_BrBG, zorder=4, vmin=-80, vmax=80, edgecolor='k', lw=0.05)
...
plt.savefig('../../../hyperdrought_data/png/LENS2_precip_trend.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()