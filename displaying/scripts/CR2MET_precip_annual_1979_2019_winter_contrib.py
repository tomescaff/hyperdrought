...
dsum = sum(dlist)
annual = cr2met.get_cr2met_annual_precip() # mm/year
winter = cr2met.get_cr2met_MJJAS_precip()*dsum # mm/season
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=10, vmax=90)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_1979_2019_winter_contrib.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()