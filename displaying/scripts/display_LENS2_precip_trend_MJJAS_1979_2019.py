...
# get LENS2 precip
trend = xr.open_dataset('../../../hyperdrought_data/data/LENS2_trend_MJJAS_1979_2019.nc')['slope']
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-1, vmax=1, edgecolor='k', lw=0.05)
...
cbar.ax.set_ylabel('MJJAS Precip Trend (1979-2019) (mm/day/dec)', fontdict={'fontsize':10})

plt.savefig('../../../hyperdrought_data/png/LENS2_precip_trend_MJJAS_1979_2019.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()