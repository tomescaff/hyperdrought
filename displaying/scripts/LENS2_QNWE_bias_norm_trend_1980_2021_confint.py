...
qn_1980_2021 = qn.sel(time=slice('1980', '2021'))
qn_1980_2021 = qn_1980_2021/qn_1980_2021.sel(time=slice('1981','2010')).mean('time')

lens2_1980_2021 = lens2.sel(time=slice('1980', '2021'))
lens2_1980_2021 = lens2_1980_2021/lens2_1980_2021.sel(time=slice('1981','2010')).mean('time')
...
lens2_trends = get_trends(lens2_1980_2021)

########################
# QN trend CI estimation 
########################

slope, intercept, r_value, p_value, std_err = stats.linregress(qn_1980_2021.time.dt.year.values, qn_1980_2021.values)

x = qn_1980_2021.time.dt.year.values
x_bar = np.mean(x)
n = qn_1980_2021.size
y = qn_1980_2021.values
...
plt.ylabel('Normed precip annual trend 1980-2021 (%/dec)')
ax = plt.gca()
...
for tick in ax.yaxis.get_major_ticks():
    tick.label.set_fontsize(8) 
    tick.label.set_weight('light')
plt.savefig('../../../hyperdrought_data/png/LENS2_QNWE_bias_norm_trend_1980_2021_confint.png', dpi=300)
plt.show()