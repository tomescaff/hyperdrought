...
mu = da.sel(time=slice('1979', '2019')).mean('time')
sig = da.sel(time=slice('1979', '2019')).std('time')
da = sig/mu*100
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_1979_2019_varcoef.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()