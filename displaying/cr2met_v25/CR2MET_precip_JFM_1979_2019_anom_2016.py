...
precip_norm = precip-precip_mean
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-320, vmax=320)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1960_2021_anom_2016.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()