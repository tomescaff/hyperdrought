...
precip_std = precip.sel(time=slice('1991', '2020')).mean('time')
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-2, vmax=2)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1960_2021_anom_std_2016.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()