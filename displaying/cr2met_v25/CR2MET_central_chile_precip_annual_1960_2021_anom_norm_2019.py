...
annual_norm = annual/annual_mean*100-100
da = annual_norm.sel(time='2019').squeeze()

mask = cr2met.get_cl_mask()
da = da*mask

stnfile = '../../../hyperdrought_data/CR2_explorer/cr2_pr_norm_anom2019_refperiod_1991_2020_24deg_40degS.nc'
...
# plot the stations
ax.scatter(stn_lon, stn_lat, s=10, c=stn_val, cmap=cmaps.amwg_blueyellowred_r, zorder=5, vmin=-100, vmax=100, edgecolors='k')
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2METv25_central_chile_precip_1960_2021_norm_anom_2019.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()