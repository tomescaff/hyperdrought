...
anom_2019 = annual.sel(time='2019') - annual_mean
da = anom_2019.squeeze()
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=4, vmin=-800, vmax=800)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2METv25_precip_1960_2021_anom_2019.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()