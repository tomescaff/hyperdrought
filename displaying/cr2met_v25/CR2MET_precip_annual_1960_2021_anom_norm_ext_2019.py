...
annual_mean = annual.sel(time=slice('1960', '2021')).mean('time')
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2METv25_precip_1960_2021_ext_norm_anom_2019.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()