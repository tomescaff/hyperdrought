...
# get CR2MET precip trend
filename = 'CR2MET_norm_trend_JFM_1979_2019.nc'
relpath = '../../../hyperdrought_data/data/' 
filepath = join(currentdir, relpath, filename)
trend = xr.open_dataset(filepath)['slope']
da = trend*10*100
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=4, vmin=-15, vmax=15)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_norm_trend.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()