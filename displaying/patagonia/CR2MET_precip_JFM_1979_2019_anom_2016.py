...
# get CR2MET precip
precip = cr2met.get_cr2met_JFM_precip_acc()/(31+28+31)
clim = precip.sel(time=slice('1981', '2010')).mean('time')
da = precip.sel(time='2016').squeeze() - clim
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-4, vmax=4)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_anom_2016.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()