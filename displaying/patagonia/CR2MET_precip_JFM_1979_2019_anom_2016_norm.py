...
precip_mean = precip.sel(time=slice('1981', '2010')).mean('time')
precip_norm = precip/precip_mean*100
da = precip_norm.sel(time='2016').squeeze()-100
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_anom_2016_norm.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()