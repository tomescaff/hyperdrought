...
filename = 'CR2MET_trend_JFM_1979_2019.nc'
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=4, vmin=-0.6, vmax=0.6)
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/CR2MET_precip_JFM_1979_2019_trend.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()