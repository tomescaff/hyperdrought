...
obs_mle_1880 = pd.read_csv(join(relpath, 'PM_metrics_PM_MLE_1880_2016_gammafit_1950_2021.csv'), index_col=0)
lens1_mle_cr = pd.read_csv(join(relpath, 'PM_metrics_LENS1_MLE_crun_2016_gammafit_1920_2021_by_return_period.csv'), index_col=0)
lens2_mle_1880 = pd.read_csv(join(relpath, 'PM_metrics_LENS2_MLE_1880_2016_gammafit_1850_2021_by_return_period.csv'), index_col=0)
...
plt.tight_layout()
plt.savefig('../../../hyperdrought_data/png/PM_sysnthesis_plot_metrics_gammafit_MLE.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()
