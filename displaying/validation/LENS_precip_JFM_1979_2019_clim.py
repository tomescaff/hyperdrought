...
# get LENS1 precip
da = lens.get_LENS1_JFM_precip_NOAA()
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/LENS_precip_JFM_1979_2019_clim.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()