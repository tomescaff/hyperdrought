...
dsum = sum(dlist)
annual = lens.get_LENS2_annual_precip_NOAA() # mm/year
winter = lens.get_LENS2_MJJAS_precip_NOAA()*dsum # mm/season
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/LENS2_precip_annual_1979_2019_winter_contrib.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()