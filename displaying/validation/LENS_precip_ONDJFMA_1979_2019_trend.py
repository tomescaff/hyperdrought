...
# get LENS precip
trend = xr.open_dataset(join(currentdir, '../../../hyperdrought_data/data/LENS1_trend_ONDJFMA_1979_2019.nc'))['slope']
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-0.4, vmax=0.4, edgecolor='k', lw=0.05)
...
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/LENS_precip_ONDJFMA_1979_2019_trend.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()