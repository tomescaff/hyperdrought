...
filename = 'PM_MLE_precip_LENS1_GMST_100_validation.nc'
lens1 = xr.open_dataset(join(relpath, filename))

filename = 'PM_MLE_precip_LENS2_GMST_10_validation.nc'
...
plt.tight_layout()
plt.savefig('../../../hyperdrought_data/png/PM_LENS1_LENS2_mle_validation.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()
