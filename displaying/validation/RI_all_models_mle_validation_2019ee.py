...
filename = 'MLE_precip_RI_GMST_10_validation.nc'
qn = xr.open_dataset(join(currentdir, relpath, filename))

filename = 'MLE_precip_LENS1_GMST_10_validation_RI.nc'
lens1 = xr.open_dataset(join(currentdir, relpath, filename))

filename = 'MLE_precip_LENS2_GMST_10_validation_RI.nc'
...
plt.tight_layout()
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/RI_all_models_mle_validation_2019ee.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()