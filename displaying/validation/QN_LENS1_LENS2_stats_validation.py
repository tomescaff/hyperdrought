...
plt.ylim([240, 960])
plt.xlim([-0.1,1.7])
plt.ylabel('Annual precip at QN - 1930-2021 mean value (mm)')
...
plt.ylim([85,325])
plt.xlim([-0.1,1.7])
plt.ylabel('Annual precip at QN - 1930-2021 standard deviation (mm)')
plt.xticks([0.2,0.8, 1.4], ["DMC (95% CI)","LENS1", "LENS2"], rotation=0)
plt.gca().spines.right.set_visible(False)
plt.gca().spines.top.set_visible(False)
plt.gca().tick_params(direction="in")
...
plt.ylim([-350,100])
plt.xlim([-0.1,1.7])
plt.ylabel('Annual precip at QN - 1930-2021 linear trend (mm/100yr)')
plt.xticks([0.2,0.8, 1.4], ["DMC (95% CI)","LENS1", "LENS2"], rotation=0)
plt.gca().spines.right.set_visible(False)
plt.gca().spines.top.set_visible(False)
plt.gca().tick_params(direction="in")
...
plt.tight_layout()
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/QN_LENS1_LENS2_stats_validation.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()