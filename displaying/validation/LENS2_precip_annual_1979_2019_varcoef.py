...
# get LENS1 precip
da_lens = lens.get_LENS2_annual_precip_NOAA()
da_std = da_lens.sel(time=slice('1979', '2019')).std('time')
da_mean = da_lens.sel(time=slice('1979', '2019')).mean('time')
da_varcoef = da_std/da_mean
da = da_varcoef.mean('run')*100
...
plt.savefig(join(currentdir,'../../../hyperdrought_data/png/LENS2_precip_annual_1979_2019_varcoef.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()