...
# get LENS2 precip
trend = xr.open_dataset(join(currentdir, '../../../hyperdrought_data/data/LENS2_trend_1979_2019.nc'))['slope']
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred_r, zorder=1, vmin=-80, vmax=80, edgecolor='k', lw=0.05)
...
plt.savefig(join(currentdir, '../../../hyperdrought_data/png/LENS2_precip_annual_1979_2019_trend.png'), dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()